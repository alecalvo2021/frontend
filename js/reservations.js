...
function updateInfo(data) {
    let myData = {
        ...
        devolutionDate: $('#devolution-date-update').val(),
        status: data.status,
    ...
    $.ajax({
        ...
        success: function(response) {
            $('#result').empty();
            $('#start-date-update').val();
            $('#devolution-date-update').val();
            getReservations();
        },
    });
...
function showDelete(id) {
    ...
    const idReservation = id;
    const confirm = document.querySelector("#btn-confirm");
    confirm.addEventListener("click", function(event) {
        deleteInfo(idReservation);
    })
}

function showDetail(data) {
    $("#start-date-detail").text(data.startDate);
    $("#devolution-date-detail").text(data.devolutionDate);
    $("#client-detail").text(data.client.name);
    $("#lib-detail").text(data.lib.name);
    $("#category-detail").text(data.lib.category.name);
    $("#capacity-detail").text(data.lib.capacity);
